    ...
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<CartDto> GetCartByUserId(string userId)
        {
            ...
            if (cart.CartHeader == null)
            {
                    ...
                    // For example, you can throw an exception, log a message, or take appropriate action.
                    throw new InvalidOperationException("No CartHeader found for the specified userId.");
            }
